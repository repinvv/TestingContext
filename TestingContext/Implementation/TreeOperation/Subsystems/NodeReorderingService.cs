namespace TestingContextCore.Implementation.TreeOperation.Subsystems
{
    ...
    using static Nodes.NodeClosestParentService;
    using static NonEqualFilteringService;

    internal static class NodeReorderingService
    {
        //public static void ReorderNodes(IDepend depend, TreeContext context, IDependency dependency1, IDependency dependency2)
        //{
        //    var node1 = context.Tree.GetDependencyNode(dependency1);
        //    var node2 = context.Tree.GetDependencyNode(dependency2);
        //    if (node1 == node2)
        //    {
        //        return;
        //    }
        ...
        //    AssignNonEqualFilter(context, node1, node2, context.GetParentGroup(depend), depend.DiagInfo);
        //}
